...
/**
 * Construit et normalise les 13 features pour le NPU.
 * À appeler après h1_push().
 * @param x13_out  Buffer de 13 floats à remplir (features scalées)
 * @return 1 si succès, 0 si ring buffer vide
 */
